...
var grammar = {
    ...
    {"name": "JVALUE", "symbols": ["SINGLE_QUOTED_STRING"], "postprocess": (d) => d[0]},
    ...
    {"name": "JOBJECT", "symbols": [{"literal":"{"}, "_", "PAIR", "JOBJECT$ebnf$1", "JOBJECT$ebnf$2", "_", {"literal":"}"}], "postprocess": extractObject},
    ...
    {"name": "SINGLE_QUOTED_STRING$ebnf$1", "symbols": []},
    {"name": "SINGLE_QUOTED_STRING$ebnf$1$subexpression$1", "symbols": [/[^\\']/]},
    {"name": "SINGLE_QUOTED_STRING$ebnf$1$subexpression$1", "symbols": [{"literal":"\\"}, /["bfnrt\/\\']/]},
    {"name": "SINGLE_QUOTED_STRING$ebnf$1$subexpression$1$string$1", "symbols": [{"literal":"\\"}, {"literal":"u"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "SINGLE_QUOTED_STRING$ebnf$1$subexpression$1", "symbols": ["SINGLE_QUOTED_STRING$ebnf$1$subexpression$1$string$1", /[a-fA-F0-9]/, /[a-fA-F0-9]/, /[a-fA-F0-9]/, /[a-fA-F0-9]/]},
    {"name": "SINGLE_QUOTED_STRING$ebnf$1", "symbols": ["SINGLE_QUOTED_STRING$ebnf$1", "SINGLE_QUOTED_STRING$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "SINGLE_QUOTED_STRING", "symbols": [{"literal":"'"}, "SINGLE_QUOTED_STRING$ebnf$1", {"literal":"'"}], "postprocess": (d) => parseSingleQuoteString(d)}
]
  , ParserStart: "MAIN"
}
